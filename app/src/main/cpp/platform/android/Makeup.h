...
#include <jni.h>
/* Header for class com_wonderful_ishow_algorithm_Makeup */

#ifndef _Included_com_wonderful_ishow_algorithm_Makeup
#define _Included_com_wonderful_ishow_algorithm_Makeup
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_wonderful_ishow_algorithm_Makeup
