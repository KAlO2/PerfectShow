...
{
public:
	// Please update com/wonderful/ishow/makeup/Makeup.java if the BlushShape is updated.
	enum class BlushShape
	{
		...
		SHAPE_COUNT  // for internal use only, must be last - used to validate shape type
	};
